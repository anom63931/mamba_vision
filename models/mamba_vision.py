...
# Code submitted by authors of Neurips submission 1041:
...
from timm.models.vision_transformer import Mlp, PatchEmbed , _
from timm.models.layers import DropPath, _, trunc_normal_
from timm.models.registry import register_model
...
def mamba_vision_B(pretrained=False, **kwargs):
    model = MambaVision(depths=[3, 3, 8, 5],
                        num_heads=[2, 4, 8, 16],
                        window_size=[8, 8, 14, 7],
                        dim=128,
                        in_dim=64,
